...
system_info <- paste0(file.path('echo cells_after_qc=', as.character(cells_number) ,' >> ', path,'config'))
system(system_info)
...
system_info <- paste0(file.path('echo subclasses_number=', as.character(subclasses_number) ,' >> ', path,'config'))
system(system_info)
...
system_info <- paste0(file.path('echo subtypes_number=', as.character(subtypes_number) ,' >> ', path,'config'))
system(system_info)
