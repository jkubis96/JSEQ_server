...
system_info <- paste0(file.path('echo subclasses_number=', as.character(as.numeric(subclasses_number)) ,' >> ', path,'config'))
system(system_info)
...
system_info <- paste0(file.path('echo subtypes_number=', as.character(as.numeric(subtypes_number)) ,' >> ', path,'config'))
system(system_info)
